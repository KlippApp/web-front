...
const { mockChangeLanguage, mockT } = vi.hoisted(() => ({
  ...
  mockT: (key, options) => {
    const translations = {
      ...
      'portal.profile.managerNameLabel': 'Manager name',
      'portal.profile.agencyNameLabel': 'Agency name',
      'portal.profile.emailLabel': 'Email',
      'portal.profile.phoneLabel': 'Phone',
      'portal.profile.streetNumberLabel': 'No.',
      'portal.profile.streetLabel': 'Street',
      'portal.profile.postalCodeLabel': 'Postal code',
      'portal.profile.cityLabel': 'City',
      'portal.profile.saveInfo': 'Save changes',
      'portal.profile.savePassword': 'Update password',
      'portal.profile.currentPasswordLabel': 'Current password',
      'portal.profile.newPasswordLabel': 'New password',
      'portal.profile.confirmNewPasswordLabel': 'Confirm new password',
      'portal.profile.loading': 'Saving…',
      'portal.profile.errorPasswordMismatch': 'Passwords do not match.',
