...
const { mockChangeLanguage, mockT } = vi.hoisted(() => ({
  ...
  mockT: (key, options) => {
    const translations = {
      ...
      'portal.dashboard.nav.agents': 'Agents',
      'portal.dashboard.nav.offices': 'Offices',
      'portal.dashboard.nav.announces': 'Listings',
      ...
      'portal.announces.title': 'Listings',
      'portal.announces.subtitle': 'Manage your real estate listings',
      'portal.announces.add': 'Add a listing',
      'portal.announces.edit': 'Edit listing',
      'portal.announces.form.photo': 'Photo',
      'portal.announces.form.title': 'Title',
      'portal.announces.form.type': 'Type',
      'portal.announces.form.typeSale': 'For sale',
      'portal.announces.form.typeRent': 'For rent',
      'portal.announces.form.price': 'Price (€)',
      'portal.announces.form.address': 'Address',
      'portal.announces.form.surface': 'Surface (m²)',
      'portal.announces.form.rooms': 'Rooms',
      'portal.announces.form.status': 'Status',
      'portal.announces.form.statusActive': 'Published',
      'portal.announces.form.statusDraft': 'Draft',
      'portal.announces.form.statusArchived': 'Archived',
      'portal.announces.form.cancel': 'Cancel',
      'portal.announces.form.submit': 'Add listing',
      'portal.announces.form.submitEdit': 'Save changes',
      'portal.announces.list.empty': 'No listings yet.',
      'portal.announces.list.edit': 'Edit',
      'portal.announces.list.stats': 'Statistics',
      'portal.announces.list.delete': 'Delete',
      'portal.announces.stats.title': 'Listing statistics',
      'portal.announces.stats.views': 'Views',
      'portal.announces.stats.contacts': 'Contacts',
      'portal.announces.stats.favorites': 'Favorites',
      'portal.announces.stats.daysOnline': 'Days online',
      'portal.announces.stats.conversionRate': 'Contact rate',
      'portal.announces.stats.viewFull': 'View full stats',
      'portal.announces.stats.backToList': 'Back to listings',
      'portal.announces.stats.viewsChart': 'Views per day',
      'portal.announces.stats.contactsChart': 'Contacts per day',
      'portal.announces.stats.sources': 'Traffic sources',
    }
